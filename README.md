...
🚀 Live Demo
Hosted on GitHub Pages: [https://joshua-steve-portfolio](https://github.com/josh6steve)
📁 Project Structure
plain
joshua-steve-audio/
├── index.html          # Main website file
├── assets/
│   ├── images/         # Profile photo and gallery
│   └── audio/          # Featured mix samples
└── README.md           # This file
🛠️ Tech Stack
...
🎨 Design Features
Dark theme with teal accent (#00e0b8)
Glassmorphism navigation with blur effect
Responsive grid layout
Embedded audio player for mix previews
